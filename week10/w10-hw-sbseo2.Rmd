...
```{r}
plot(cutoffs, cancer_sens, type="b", lty=1, col="dodgerblue", ylab="value", main="Sensitivity/Specificity vs Cuttoffs")
...
Approximately, `0.8` seems to be ideal for $c$. That is because this value is the point where true positive rate and true negative rate equal to each other.
