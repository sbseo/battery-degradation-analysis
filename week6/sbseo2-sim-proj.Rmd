...
for (i in 1:1000){
  ...
  trn_data$y = beta_0 + beta_1*trn_data$x1+ beta_2*trn_data$x2 + beta_3*trn_data$x3 + beta_4*trn_data$x4 + beta_5*trn_data$x5 + beta_6*trn_data$x6 + epsilon
  
  model1 = lm(y ~ x1, data=trn_data)
  model2 = lm(y ~ x1+x2, data=trn_data)
  model3 = lm(y ~ x1+x2+x3, data=trn_data)
  model4 = lm(y ~ x1+x2+x3+x4, data=trn_data)
  model5 = lm(y ~ x1+x2+x3+x4+x5, data=trn_data)
  model6 = lm(y ~ x1+x2+x3+x4+x5+x6, data=trn_data)
  model7 = lm(y ~ x1+x2+x3+x4+x5+x6+x7, data=trn_data)
  model8 = lm(y ~ x1+x2+x3+x4+x5+x6+x7+x8, data=trn_data)
  model9 = lm(y ~ x1+x2+x3+x4+x5+x6+x7+x8+x9, data=trn_data)
